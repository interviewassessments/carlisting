export const initialCarListingsData = [];

export const initialRandomImageData = [
  {
    id: '0',
...
// This can be created as new file in real time with all the copyright text
export const appText = {
  ...
  carMake: 'Car Make',
  carMakePlaceholder: 'Enter Car Make',
  carColor: 'Car Color',
  carColorPlaceholder: 'Enter Color Name',
